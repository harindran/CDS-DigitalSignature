...
Namespace DigitalSignature
    <FormAttribute("133", "Business Objects/FrmARInvoice.b1f")>
    Friend Class FrmARInvoice
        ...
        Private Sub OnCustomInitialize()
            Try
                FormCount += 1
                objform = objaddon.objapplication.Forms.GetForm("133", FormCount)
                Button0.Item.Enabled = False
                'Button0.Item.Left = objform.Items.Item("2").Left + objform.Items.Item("2").Width + 5
                'Button0.Item.Top = objform.Items.Item("2").Top
